...
struct AkArrayAllocatorNoAlign
{
	 ...
	 void Free( void * in_pAddress )
	{
	 ...
	 void TransferMem(void *& io_pDest, AkArrayAllocatorNoAlign<U_POOL> in_srcAlloc, void * in_pSrc ) 
	{
		io_pDest = in_pSrc;
	}
};
...
struct AkArrayAllocatorAlignedSimd
{
	 ...
	 void Free( void * in_pAddress )
	{
	 ...
	 void TransferMem(void *& io_pDest, AkArrayAllocatorAlignedSimd<U_POOL> in_srcAlloc, void * in_pSrc ) 
	{
		io_pDest = in_pSrc;
	}
...
struct AkHybridAllocator
{
	 ...
	 void Free(void * in_pAddress)
	{
	 ...
	 void TransferMem(void *& io_pDest, AkHybridAllocator<uBufferSizeBytes, uAlignmentSize>& in_srcAlloc, void * in_pSrc)
	{
