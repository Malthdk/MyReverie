...
class ApiHeaderBlobberSwitch(ApiHeaderBlobber):
	def __init__(self, pathMan):
		ApiHeaderBlobber.__init__(self, pathMan)

		self.inputHeaders.append(normpath(join(self.SdkIncludeDir, 'AK/SoundEngine/Platforms/NX/AkNXSoundEngine.h')))
...
class PlatformSwitch(PlatformHandler):
	def __init__(self, pathMan):
		PlatformHandler.__init__(self, pathMan)

		PlatformInitSettingHeader = 'AK/SoundEngine/Platforms/NX/AkNXSoundEngine.h'
		...
		self.ioFileSources = \
		[
			join(self.pathMan.Paths['Wwise_SDK_Samples'], 'SoundEngine\\NX\\stdafx.cpp'),
			join(self.pathMan.Paths['Wwise_SDK_Samples'], 'SoundEngine\\NX\\stdafx.h'),
			join(self.pathMan.Paths['Wwise_SDK_Samples'], 'SoundEngine\\NX\\AkFileHelpers.h'),
			join(self.pathMan.Paths['Wwise_SDK_Samples'], 'SoundEngine\\NX\\AkFileHelpers.cpp'),
			join(self.pathMan.Paths['Wwise_SDK_Samples'], 'SoundEngine\\NX\\AkDefaultIOHookBlocking.cpp'),
			join(self.pathMan.Paths['Wwise_SDK_Samples'], 'SoundEngine\\NX\\AkDefaultIOHookBlocking.h'),
			join(self.pathMan.Paths['Wwise_SDK_Samples'], 'SoundEngine\\NX\\AkFilePackageLowLevelIOBlocking.h')			
		]
...
def CreatePlatformBlobber(PlatformName, pathMan):
	...
	if PlatformName == 'Mac':
		...
		return ApiHeaderBlobberSwitch(pathMan)
	else:
		return None
